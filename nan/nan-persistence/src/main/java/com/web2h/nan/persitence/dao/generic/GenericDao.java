...
public interface GenericDao<E, PK extends Serializable> {
	 ...
	 * 
	 * @param entity The new entity to persist
	...
	/**
	 * Gets all the elements from the table in the range defined by the given page.
	 * 
	 ...
	 * 
	 * @param criterions Filters
	 * @return The subset of elements
	 */
	List<E> readByCriterias(Criterion... criterions);

	/**
	 * Gets a subset of a table based on the given field condition (only equality).
	 * 
